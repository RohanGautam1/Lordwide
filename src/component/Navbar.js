    ...
    return (
        <div className='container ' style={{ height: "20vh" }}>
            <div className='row d-flex  '>
                <div className='col-6   '>
                    <h2 className="heading " style={{ fontSize: "2.8rem", marginTop:"1rem", color: "#000000", fontWeight: 800, }}>My Account</h2>          {/*{MenuData.menuheading}*/}
                    <p className="para " style={{
                        fontSize: "20px", color: "#7A86A1", fontWeight: 800,
