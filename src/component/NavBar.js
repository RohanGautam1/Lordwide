...
//            <h1 className="heading">{MenuData.menuheading}</h1>          {/*{MenuData.menuheading}*/}
//               <p className="para">122</p>                 {/*{MenuData.menudesc}*/}
//            </div>
...
//            </div>
//            <div className='col-md-2  col-6  d-flex  align-items-center   mt-2'>
