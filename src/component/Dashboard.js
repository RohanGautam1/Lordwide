...
function Dashboard() {
    ...
    const data = [
        ...
        {tablenum:4,bill:406,time:47,paymode:'crdt'}
    ]
            ...
            <div className="container-fluid d-flex flex-wrap" >
                ...
                <div className="col-md-7">
                    ...
                    <div className="row d-flex flex-wrap">
                        ...
                        {/* ====================================================================== */}
                        <div className='col-md-6 mt-5 Order-in-Progress border'>
                            ...
                            <div className="row">
                                ...
                                <di v className='d-flex justify-content-space-between'>
                                <button type="button" class="btn btn-outline-dark rounded-5 btn-sm m-2">
                                    All Orders
                                </button>
